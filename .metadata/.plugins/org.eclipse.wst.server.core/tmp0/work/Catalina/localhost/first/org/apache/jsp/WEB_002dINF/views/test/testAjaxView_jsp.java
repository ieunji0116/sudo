 ...
 * Generated at: 2024-09-25 09:08:37 UTC
...
public final class testAjaxView_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("//window.onload = function(){ 태그객체.이벤트명 = function(){ 이벤트 발생시 처리내용 작성 }};\r\n");
      out.write("//jQuery.document.ready(function(){ 태그객체.이벤트명 = function(){ 이벤트 발생시 처리내용 작성 }});\r\n");
      out.write("//window.onload 와 jQuery.document.ready 는 의미가 같음 : 브라우저에 문서 읽어들이기가 완료되면을 의미함\r\n");
      out.write("//jQuery 는 줄임말로 $ 로 표기함\r\n");
      out.write("//jQuery.document.ready(function(){}); 는 줄여서 $(function(){}); 표기해도 됨\r\n");
      out.write("$(function(){\r\n");
      ...
      out.write("				//decodeURIComponent(응답값) 사용해서 반드시 디코딩 처리해야 함\r\n");
      ...
      out.write("<script type=\"text/javascript\">\r\n");
      out.write("$(function(){\r\n");
      out.write("	//jQuery('selector').method(...);  줄여서 $('태그선택자').이벤트메소드(function(){ 이벤트발생시 실행할 내용 });\r\n");
      ...
      out.write("				var jsonObj = JSON.parse(objStr);  //jsonObj 안에 저장된 list (json 배열임) 가 있음\r\n");
      out.write("				\r\n");
      ...
      out.write("	//form 태그 안의 입력양식들의 값들을 담을 FormData 내장객체 생성함\r\n");
